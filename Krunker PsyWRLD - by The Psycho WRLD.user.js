// ==UserScript==
// @name Krunker  PsyWRLD - by The Psycho WRLD
// @description   The most advanced krunker cheat
// @version       3.7.5
// @author        Psycho - From Psycho WRLD
    ...
    class Dogeware {
        ...
        initGUI() {
            function createButton(name, iconURL, fn) {
                ...
                menuItemIcon.style.backgroundImage = `url("https://media2.giphy.com/media/Th3m2LjHDYovxiUPlh/giphy_s.gif")`
...
<img src="https://i.imgur.com/1ULgtUd.png" width="90%">
